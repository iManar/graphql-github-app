  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
          GraphQLField("repositories", arguments: ["first": 10, "orderBy": ["field": "CREATED_AT", "direction": "DESC"]], type: .nonNull(.object(Repository.selections))),
        ]
      }
...
public final class CreateRepositoryMutation: GraphQLMutation {
  ...
  public let operationDefinition: String =
    ...
    mutation createRepository($name: String!, $description: String, $visibility: RepositoryVisibility!, $clientMutationId: String) {
      createRepository(
        input: {name: $name, description: $description, visibility: $visibility, clientMutationId: $clientMutationId}
      ) {
        __typename
        clientMutationId
      }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("createRepository", arguments: ["input": ["name": GraphQLVariable("name"), "description": GraphQLVariable("description"), "visibility": GraphQLVariable("visibility"), "clientMutationId": GraphQLVariable("clientMutationId")]], type: .object(CreateRepository.selections)),
      ]
    }
